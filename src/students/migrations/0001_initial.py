    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='students.country')),
                ('student_shekh_mohafez', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='students.shekh_mohafez')),
                ('student_shekh_tester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='students.shekh_tester')),
            ],
        ),
    ]
